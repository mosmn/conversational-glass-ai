...
export function CreateBranchModal({
  ...
  const handleCreate = async () => {
    if (!branchName.trim() || !content.trim()) return;
      ...
      <DialogContent className="max-w-2xl bg-slate-900/95 backdrop-blur-xl border-slate-700/50">
        <DialogHeader className="space-y-3">
          <DialogTitle className="flex items-center space-x-2 text-xl">
            ...
            <span>Create Conversation Branch</span>
          </DialogTitle>
          <DialogDescription className="text-slate-400">
            Explore alternative conversation paths from this message
          </DialogDescription>
        </DialogHeader>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-slate-300 leading-relaxed">
                      {truncateText(parentMessage.content, 200)}
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                >
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onKeyPress={handleKeyPress}
                      placeholder="What would you like to say in this new branch? This will be your first message..."
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-xs text-slate-400">
                            This will create a new conversation path where you
                            can explore alternative responses
                          </p>
                        </div>
                      </div>
                    </CardContent>
