      ...
      <div className="p-4 border-b border-slate-700/50">
        <div className="flex items-center justify-between">
          <ConversationalGlassLogo
            size={isMobile ? "sm" : "md"}
            animated={true}
            showText={!sidebarCollapsed || isMobile}
            ...
            <div className="p-4">
              ...
              {user && (
                <div className="relative group">
                  ...
                  <div className="relative p-3 sm:p-4 bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-xl">
                    <div className="flex items-center gap-3">
                      <div className="relative">
                        <Avatar className="w-10 h-10 sm:w-12 sm:h-12 border-2 border-emerald-500/30">
                          <AvatarImage
                            src={user.imageUrl}
                        ...
                        <div className="absolute -bottom-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-emerald-500 rounded-full border-2 border-slate-800 flex items-center justify-center">
    ...
    <div className="min-h-screen bg-slate-900 text-white overflow-hidden">
      ...
      <div className="flex h-screen relative z-10">
        {isMobile ? (
          ...
          <>
            {/* Mobile Header */}
            <div className="w-full fixed top-0 left-0 right-0 z-50 bg-slate-800/40 backdrop-blur-xl border-b border-slate-700/50">
              <div className="flex items-center justify-between px-4 py-3">
                <div className="flex items-center gap-3">
                  ...
                  >
                    ...
                    <SheetContent
                      side="left"
                      className="w-80 p-0 bg-slate-800/95 backdrop-blur-xl border-slate-700/50"
                    >
                      <SidebarContent
          ...
          <>
            ...
            <motion.div
              ...
              className={`${
                sidebarCollapsed ? "w-20" : isTablet ? "w-64" : "w-80"
            ...
            <div className="flex-1 flex flex-col min-w-0">
              ...
              >
                ...
                <div className="relative flex items-center justify-between px-4 lg:px-6 py-4 lg:py-6">
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-3">
                      <div className="w-1 h-6 lg:h-8 bg-gradient-to-b from-emerald-500 to-teal-500 rounded-full" />
                      <div>
                        <h1 className="text-xl lg:text-2xl font-bold bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">
                          {currentTitle}
                        </h1>
